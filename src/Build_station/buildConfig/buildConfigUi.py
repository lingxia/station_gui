...
#
# Created: Thu Aug 14 23:17:30 2014
...
class Ui_buildConfig(object):
    def setupUi(self, buildConfig):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(30, 160, 84, 361))
        ...
        self.iarButton.setIconSize(QtCore.QSize(40, 40))
        ...
        self.uv4Button.setIconSize(QtCore.QSize(40, 40))
        ...
        self.gccButton.setIconSize(QtCore.QSize(40, 40))
        ...
        self.kdsButton.setIconSize(QtCore.QSize(40, 40))
        ...
        self.cw10Button.setIconSize(QtCore.QSize(40, 40))
        ...
        self.mingwButton.setIconSize(QtCore.QSize(32, 32))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(120, 150, 181, 391))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(310, 150, 77, 391))
        ...
        self.gccSelectButton = QtGui.QPushButton(self.verticalLayoutWidget_3)
        self.gccSelectButton.setObjectName(_fromUtf8("gccSelectButton"))
        self.ideComboBoxVLayout.addWidget(self.gccSelectButton)
        self.kdsButton_2 = QtGui.QPushButton(self.verticalLayoutWidget_3)
        self.kdsButton_2.setObjectName(_fromUtf8("kdsButton_2"))
        self.ideComboBoxVLayout.addWidget(self.kdsButton_2)
        self.cw10Button_2 = QtGui.QPushButton(self.verticalLayoutWidget_3)
        self.cw10Button_2.setObjectName(_fromUtf8("cw10Button_2"))
        self.ideComboBoxVLayout.addWidget(self.cw10Button_2)
        self.mingwButton_2 = QtGui.QPushButton(self.verticalLayoutWidget_3)
        self.mingwButton_2.setObjectName(_fromUtf8("mingwButton_2"))
        self.ideComboBoxVLayout.addWidget(self.mingwButton_2)
    ...
    def retranslateUi(self, buildConfig):
        ...
        self.ideLabel.setStatusTip(_translate("buildConfig", "Config the IDEs that needed", None))
        ...
        self.iarComboBox.setStatusTip(_translate("buildConfig", "Configurate your IAR path", None))
        self.uv4ComboBox.setStatusTip(_translate("buildConfig", "Configurate your UV4 path", None))
        self.gccSelectButton.setStatusTip(_translate("buildConfig", "Configurate your GCC path", None))
        self.gccSelectButton.setText(_translate("buildConfig", "Select", None))
        self.kdsButton_2.setStatusTip(_translate("buildConfig", "Configurate your KDS path", None))
        self.kdsButton_2.setText(_translate("buildConfig", "Select", None))
        self.cw10Button_2.setStatusTip(_translate("buildConfig", "Configurate your Code Worrior path", None))
        self.cw10Button_2.setText(_translate("buildConfig", "Select", None))
        self.mingwButton_2.setStatusTip(_translate("buildConfig", "Configurate your MinGW path", None))
        self.mingwButton_2.setText(_translate("buildConfig", "Select", None))
