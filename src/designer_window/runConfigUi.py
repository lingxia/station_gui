...
#
# Created: Sun Aug 17 23:58:44 2014
...
class Ui_runConfig(object):
    def setupUi(self, runConfig):
        ...
        self.debuggerStackedWidget.setGeometry(QtCore.QRect(90, 120, 501, 351))
        ...
        self.jlinkPlatformButton.setGeometry(QtCore.QRect(10, 60, 61, 21))
        ...
        self.jlinkPlatformComboBox.setGeometry(QtCore.QRect(80, 60, 141, 22))
        ...
        self.jlinkTreeWidget.setGeometry(QtCore.QRect(0, 120, 501, 221))
        ...
        self.jlinkTreeWidget.header().setDefaultSectionSize(125)
        ...
        self.lauterbachPlatformButton.setGeometry(QtCore.QRect(0, 60, 61, 21))
        ...
        self.lauterbachPlatformComboBox.setGeometry(QtCore.QRect(70, 60, 141, 22))
    ...
    def retranslateUi(self, runConfig):
        ...
        self.jlinkTreeWidget.headerItem().setText(2, _translate("runConfig", "Serial_Port", None))
        self.jlinkTreeWidget.headerItem().setText(3, _translate("runConfig", "Debug_Port", None))
